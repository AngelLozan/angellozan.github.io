...
order: 4
---
> Confira meu [GitHub](https://github.com/AngelLozan) <i class="fab fa-github"></i>
{: .prompt-tip }



<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&width=435&lines=Olá%2C+obrigado+por+visitar+%F0%9F%91%8B+;Sou+Desenvolvedor+Full-stack+Ruby+e+JS;Dê+uma+olhada+%F0%9F%91%80+;Me+avise+suas+perguntas!" alt="Typing SVG" /></a>


Engenheiro de Software experiente com vários anos de experiência no desenvolvimento de aplicações web e sistemas backend. Habilidoso em desenvolvimento Full Stack. Constantemente construindo. Outras áreas de expertise: Comunicações, Web3 e Segurança.

Com quem já desenvolvi software:
...
Construí e mantive múltiplas aplicações full stack, microsserviços e plataformas SaaS em várias linguagens. De microsserviços GoLang para suportar um gigante do e-commerce até um Dapp Polygon full stack, uma plataforma SaaS Java, um clone Ruby on Rails do Zendesk com recursos Web3 como um explorador de blocos integrado e integrações de API de carteira, e quatro extensões Chrome para ajudar na automação e plataformas abrangentes de ingressos para arte. 

Tenho aprendido constantemente novas tecnologias para encontrar soluções criativas para questões únicas de automação, engajamento social ou publicidade. Puppeteer, Node, React, Vue, Next, Ruby, Rails e Redux. Estou aprendendo GoLang no momento.
   ...
   <div class="d-flex justify-content-center p1">
      <a href="https://github.com/AngelLozan/AngelLozan/blob/main/README.md">
         <span class="p2">
            <img alt="profile views" title="Quem está assistindo?" src="https://komarev.com/ghpvc/?username=angellozan&label=Visualizações+do+perfil&color=0e75b6&style=for-the-badge" alt="angellozan" />
         </span>
      </a> 
      <a href="https://github.com/AngelLozan?tab=followers">
        <span class="p2">
         <img alt="followers" title="Me siga no Github" src="https://custom-icon-badges.demolab.com/github/followers/AngelLozan?color=236ad3&labelColor=1155ba&style=for-the-badge&logo=person-add&label=Seguir&logoColor=white"/>
        </span>
      </a>
      <a href="https://github.com/AngelLozan?tab=repositories&sort=stargazers">
        <span class="p2">
            <img alt="total stars" title="Total de estrelas no GitHub" src="https://custom-icon-badges.demolab.com/github/stars/AngelLozan?color=55960c&style=for-the-badge&labelColor=488207&logo=star"/>
        </span>
      </a>
   </div>
...
<div class="row d-flex justify-content-center align-items-center">
    <p>
        ...
        <a href="https://bsky.app/profile/angellozan.live" target="blank"><img align="center" src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Bluesky_Logo.svg" alt="Angel no bluesky" height="30" width="40" /></a>
    </p>
</div>
---
